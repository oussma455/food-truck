...
export const SANDWICH_CATEGORIES: Category[] = [
  {
    ...
    options: [
      ...
      { id: "b2", name: "Pain Brioché", price: 1.5 },
      { id: "b3", name: "Pain Complet", price: 0.5 },
    ],
  },
  {
    id: "meat",
    ...
    options: [
      ...
      { id: "m2", name: "Poulet Mariné", price: 4 },
      { id: "m3", name: "Falafel Maison", price: 3.5 },
      { id: "m4", name: "Steak Boucher", price: 4.5 },
    ],
  },
  {
    id: "sauces",
    ...
    options: [
      { id: "s1", name: "Maison Truffée", price: 0.5 },
      { id: "s2", name: "Algérienne", price: 0 },
      { id: "s3", name: "Mayo-Ail", price: 0 },
      { id: "s4", name: "BBQ Fumée", price: 0 },
    ],
  },
  {
    id: "extras",
